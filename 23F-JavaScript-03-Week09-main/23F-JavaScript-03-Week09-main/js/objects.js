...
var person = {
  ...
  bio: function () {
    return `The interests of ${this.name.firstName} ${
      this.name.lastName
    } of age ${this.age} of gender ${this.gender} are ${this.interests.join(
      ", "
    )}.`;
  },
};
...
called "greeting" that creates an alert dialog, then type person.greetings() into the console */
